...
const Carousel = () => {
     const pedidosData = [
        {   id:1,
            ...
            nombre:"muzzarella",
            precio:"$25",
            parrafo:" Esta variedad de pizza la puedes degustar con tu familia y amigos, sus ingredientes son queso , aceitunas salsas y demàs que dejar+an e tu paladar el sabor que nos identifica", 
        },
        {
            id:2,
            imagen:`${napolitana}`,
